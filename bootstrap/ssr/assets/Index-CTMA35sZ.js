...
import { C as CardTable, T as TableData, a as TableHead } from "./CardTable-_z_BdlNV.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(CardTable, {
              ...
              cardHeader: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex justify-between items-center"${_scopeId2}><h4 class="text-2xl"${_scopeId2}>Apply filters(${ssrInterpolate(__props.orders.total)})</h4>`);
                  ...
                  return [
                    createVNode("div", { class: "flex justify-between items-center" }, [
                      createVNode("h4", { class: "text-2xl" }, "Apply filters(" + toDisplayString(__props.orders.total) + ")", 1),
                ...
                if (_push3) {
                  ...
                  ssrRenderList(selectedOrder.value.order_items, (orderItem, index) => {
                    ...
                    _push3(ssrRenderComponent(TableData, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img${ssrRenderAttr("src", orderItem.product_json.photo)} class="h-12 w-12 bg-white rounded-full border" alt="Inventory management system"${_scopeId3}><span class="ml-3 font-bold text-blueGray-600"${_scopeId3}>${ssrInterpolate(unref(truncateString)(orderItem.product_json.name, 15))}</span>`);
                        } else {
                          return [
                            createVNode("img", {
