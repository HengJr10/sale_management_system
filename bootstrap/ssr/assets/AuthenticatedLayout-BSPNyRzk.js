...
import { _ as _sfc_main$7 } from "./ApplicationLogo-BzQ-yG8f.js";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><a class="text-blueGray-500 block" href="#pablo"><div class="items-center flex"><span class="w-12 h-12 text-sm text-white bg-blueGray-200 inline-flex items-center justify-center rounded-full"><img alt="..." class="w-full rounded-full align-middle border-none shadow-lg"${ssrRenderAttr("src", _ctx.$page.props.auth.user.photo)}></span></div></a><div class="${ssrRenderClass([{
    hidden: !$data.dropdownPopoverShow,
    block: $data.dropdownPopoverShow
