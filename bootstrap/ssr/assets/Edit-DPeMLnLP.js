import { ref, onMounted, unref, withCtx, createTextVNode, createVNode, withDirectives, withKeys, vModelText, vModelSelect, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrInterpolate } from "vue/server-renderer";
...
import { d as default_image } from "./default-image-BsTyGE_5.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex flex-col"${_scopeId}><div class="relative cursor-pointer"${_scopeId}><img${ssrRenderAttr("alt", _ctx.$page.props.auth.user.name)}${ssrRenderAttr("src", previewImage.value || unref(default_image))} class="shadow-xl h-auto align-middle border-none absolute max-w-150-px" style="${ssrRenderStyle({ "max-width": "400px !important", "height": "150px !important" })}" title="Upload Photo"${_scopeId}>`);
            if (isHovered.value) {
              _push2(`<div class="absolute flex items-center justify-center rounded-full"${_scopeId}><i class="fas fa-camera text-black text-2xl"${_scopeId}></i></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<input type="file" class="hidden" accept="image/*"${_scopeId}></div>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
                        ...
                        createVNode("div", { class: "flex flex-col" }, [
                          createVNode("div", {
                            ...
                            createVNode("img", {
                              ...
                              src: previewImage.value || unref(default_image),
                              ...
                              title: "Upload Photo"
                            }, null, 8, ["onClick", "alt", "src"]),
                            isHovered.value ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "absolute flex items-center justify-center rounded-full"
                            }, [
                              createVNode("i", { class: "fas fa-camera text-black text-2xl" })
