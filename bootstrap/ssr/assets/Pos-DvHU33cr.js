import { watch, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, withKeys, withDirectives, vModelSelect, vModelText, useSSRContext } from "vue";
...
import { n as numberFormat, t as truncateString, g as getCurrency, A as AsyncVueSelect, s as showToast } from "./AsyncVueSelect-DAiIkMoY.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-wrap" data-v-34188d5d${_scopeId}><div class="w-full px-4" data-v-34188d5d${_scopeId}><div class="relative -mt-16 flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white" data-v-34188d5d${_scopeId}><div class="flex lg:flex-row flex-col-reverse shadow-lg" data-v-34188d5d${_scopeId}><div class="lg:w-4/5 min-h-screen shadow-lg overflow-auto max-h-screen" data-v-34188d5d${_scopeId}><div class="flex flex-row justify-between items-center px-5 mt-5" data-v-34188d5d${_scopeId}><div class="text-gray-800" data-v-34188d5d${_scopeId}><div class="font-bold text-xl" data-v-34188d5d${_scopeId}>Products</div></div></div><div class="grid grid-cols-3 gap-4 px-5 mt-5 overflow-y-auto h-4/6" data-v-34188d5d${_scopeId}><!--[-->`);
            ssrRenderList(__props.products.data, (product, index) => {
              var _a;
              _push2(`<div role="button" class="select-none cursor-pointer transition-shadow rounded-md bg-white shadow hover:shadow-lg border border-gray-200 flex flex-col justify-between max-h-56"${ssrRenderAttr("title", product.name)} data-v-34188d5d${_scopeId}><div class="flex justify-center items-center md:p-3" data-v-34188d5d${_scopeId}><img${ssrRenderAttr("src", product.photo)} class="max-h-40 object-cover rounded-md"${ssrRenderAttr("alt", product.name)} data-v-34188d5d${_scopeId}></div><div class="flex pb-3 px-3 text-sm" data-v-34188d5d${_scopeId}><p class="flex-grow truncate mr-1" data-v-34188d5d${_scopeId}>`);
              if (product.quantity > 0) {
                _push2(`<span class="text-xs font-semibold inline-block py-1 px-2 rounded text-emerald-600 bg-emerald-200" data-v-34188d5d${_scopeId}>${ssrInterpolate(product.quantity)}${ssrInterpolate((_a = product.unit_type) == null ? void 0 : _a.symbol)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (product.quantity < 1) {
                _push2(`<span class="text-xs font-semibold inline-block py-1 px-2 rounded text-red-600 bg-red-200" data-v-34188d5d${_scopeId}>0</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(` ${ssrInterpolate(unref(truncateString)(product.name, 11))}</p><p class="nowrap font-semibold" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(product.selling_price)}</p></div></div>`);
            });
            _push2(`<!--]--></div></div><div class="lg:w-2/5" data-v-34188d5d${_scopeId}><div class="flex flex-row items-center justify-between px-5 mt-5" data-v-34188d5d${_scopeId}><div class="font-bold text-xl" data-v-34188d5d${_scopeId}>Cart</div><div class="font-semibold" data-v-34188d5d${_scopeId}><span${ssrRenderAttr("role", __props.carts.total > 0 ? "button" : null)} class="px-4 py-2 rounded-md bg-red-100 text-red-500" data-v-34188d5d${_scopeId}>Clear(${ssrInterpolate(__props.carts.total)})</span></div></div><div class="px-5 py-2 overflow-y-auto h-64" data-v-34188d5d${_scopeId}><!--[-->`);
            ssrRenderList(__props.carts.data, (cart) => {
              var _a;
              _push2(`<div class="${ssrRenderClass([cart.quantity > cart.product.quantity ? "bg-red-200" : "", "flex flex-row justify-between items-center mb-4"])}" data-v-34188d5d${_scopeId}><div class="flex flex-row items-center w-2/5"${ssrRenderAttr("title", cart.product.name)} data-v-34188d5d${_scopeId}><img${ssrRenderAttr("src", cart.product.photo)} class="w-10 h-10 object-cover rounded-md"${ssrRenderAttr("alt", cart.product.name)} data-v-34188d5d${_scopeId}><span class="ml-1 font-semibold text-sm" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(truncateString)(cart.product.name))} <br data-v-34188d5d${_scopeId}> Q: ${ssrInterpolate(unref(numberFormat)(cart.product.quantity))} ${ssrInterpolate((_a = cart.product.unit_type) == null ? void 0 : _a.symbol)}</span></div><div class="flex justify-between" data-v-34188d5d${_scopeId}><span role="button" class="px-3 py-1 rounded-l-md bg-gray-300" data-v-34188d5d${_scopeId}>-</span><input type="number" class="font-semibold border-gray-300 px-0.5 py-1 w-10 text-center"${ssrRenderAttr("value", cart.quantity)} data-v-34188d5d${_scopeId}><span role="button" class="px-3 py-1 rounded-r-md bg-gray-300" data-v-34188d5d${_scopeId}>+</span></div><div class="font-semibold text-lg w-16 text-center" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(unref(numberFormat)(cart.quantity * cart.product.selling_price))}</div><i role="button" class="fa fa-trash-alt text-red-500" data-v-34188d5d${_scopeId}></i></div>`);
            });
            _push2(`<!--]--></div><div class="px-5 mt-1" data-v-34188d5d${_scopeId}><div class="pt-2 rounded-md shadow-lg" data-v-34188d5d${_scopeId}><div class="px-4 flex justify-between" data-v-34188d5d${_scopeId}><span class="font-semibold text-sm" data-v-34188d5d${_scopeId}>Subtotal</span><span class="font-bold" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(__props.cartSubtotal)}</span></div><div class="px-4 flex justify-between" data-v-34188d5d${_scopeId}><span class="font-semibold text-sm" data-v-34188d5d${_scopeId}>Sales Tax(${ssrInterpolate(__props.tax)}%)</span><span class="font-bold" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(__props.totalTax)}</span></div><div class="px-4 flex justify-between" data-v-34188d5d${_scopeId}>`);
            if (__props.discountType === "fixed") {
              _push2(`<span class="font-semibold text-sm" data-v-34188d5d${_scopeId}>Discount(${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(__props.discount)})</span>`);
            } else {
              _push2(`<span class="font-semibold text-sm" data-v-34188d5d${_scopeId}>Discount(${ssrInterpolate(__props.discount)}%)</span>`);
            }
            _push2(`<span class="font-bold" data-v-34188d5d${_scopeId}>- ${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(__props.totalDiscount)}</span></div><div class="px-4 flex justify-between items-center" data-v-34188d5d${_scopeId}><div class="text-sm flex items-center flex-wrap" data-v-34188d5d${_scopeId}><span class="font-semibold text-sm mr-1" data-v-34188d5d${_scopeId}>Custom Discount - </span><div class="flex" data-v-34188d5d${_scopeId}><select class="px-3 py-1 w-14 rounded-l-md bg-gray-300 border-none" data-v-34188d5d${_scopeId}><option value="fixed" data-v-34188d5d${ssrIncludeBooleanAttr(Array.isArray(unref(form).custom_discount.discount_type) ? ssrLooseContain(unref(form).custom_discount.discount_type, "fixed") : ssrLooseEqual(unref(form).custom_discount.discount_type, "fixed")) ? " selected" : ""}${_scopeId}>=</option><option value="percentage" data-v-34188d5d${ssrIncludeBooleanAttr(Array.isArray(unref(form).custom_discount.discount_type) ? ssrLooseContain(unref(form).custom_discount.discount_type, "percentage") : ssrLooseEqual(unref(form).custom_discount.discount_type, "percentage")) ? " selected" : ""}${_scopeId}>%</option></select><input${ssrRenderAttr("value", unref(form).custom_discount.discount)} type="number" class="font-semibold border-gray-300 px-0.5 py-1 w-10 text-center" data-v-34188d5d${_scopeId}></div></div>`);
            if (unref(form).custom_discount.discount_type === "fixed") {
              _push2(`<span class="font-bold" data-v-34188d5d${_scopeId}>- ${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(unref(form).custom_discount.discount)}</span>`);
            } else {
              _push2(`<span class="font-bold" data-v-34188d5d${_scopeId}>- ${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(unref(numberFormat)(__props.cartSubtotal * (unref(form).custom_discount.discount / 100)))}</span>`);
            }
            _push2(`</div><div class="border-t-2 mt-3 py-2 px-4 flex items-center justify-between" data-v-34188d5d${_scopeId}><span class="font-semibold text-2xl" data-v-34188d5d${_scopeId}>Total</span><span class="font-bold text-2xl" data-v-34188d5d${_scopeId}>${ssrInterpolate(unref(getCurrency)())}${ssrInterpolate(unref(form).total)}</span></div></div></div><div class="px-5 mt-1" data-v-34188d5d${_scopeId}><div class="rounded-md shadow-lg px-4 py-4" data-v-34188d5d${_scopeId}><div data-v-34188d5d${_scopeId}><label for="customer" class="text-stone-600 text-sm font-medium" data-v-34188d5d${_scopeId}>Customer</label>`);
            ...
            _push2(`</div><div data-v-34188d5d${_scopeId}><label for="paid" class="text-stone-600 text-sm font-medium" data-v-34188d5d${_scopeId}>Pay</label><div class="flex mt-1" data-v-34188d5d${_scopeId}><select id="paid_through" class="w-1/2 rounded-l-md bg-gray-300 border-none px-2 py-2 outline-none focus:outline-none" data-v-34188d5d${_scopeId}><!--[-->`);
            ssrRenderList(__props.orderPaidByTypes, (orderPaidByType, index) => {
              _push2(`<option${ssrRenderAttr("value", orderPaidByType.value)} data-v-34188d5d${_scopeId}>${ssrInterpolate(orderPaidByType.label)}</option>`);
            });
            _push2(`<!--]--></select><input id="paid" placeholder="Enter paid amount"${ssrRenderAttr("value", unref(form).paid)} type="text" class="w-full rounded-r-md border border-gray-200 px-2 py-2 shadow-sm outline-none focus:outline-none focus:shadow-outline" data-v-34188d5d${_scopeId}></div>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              message: unref(form).errors.paid
            }, null, _parent2, _scopeId));
            _push2(`</div></div></div><div class="px-5 mt-3 mb-4" data-v-34188d5d${_scopeId}>`);
                  ...
                  createVNode("div", { class: "relative -mt-16 flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white" }, [
                    createVNode("div", { class: "flex lg:flex-row flex-col-reverse shadow-lg" }, [
                      createVNode("div", { class: "lg:w-4/5 min-h-screen shadow-lg overflow-auto max-h-screen" }, [
                        ...
                        createVNode("div", { class: "grid grid-cols-3 gap-4 px-5 mt-5 overflow-y-auto h-4/6" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(__props.products.data, (product, index) => {
                            ...
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex justify-center items-center md:p-3" }, [
                                createVNode("img", {
                                  src: product.photo,
                              ...
                              createVNode("div", { class: "flex pb-3 px-3 text-sm" }, [
                                createVNode("p", { class: "flex-grow truncate mr-1" }, [
                                  ...
                                  createTextVNode(" " + toDisplayString(unref(truncateString)(product.name, 11)), 1)
                                ]),
                      ...
                      createVNode("div", { class: "lg:w-2/5" }, [
                        ...
                        createVNode("div", { class: "px-5 py-2 overflow-y-auto h-64" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(__props.carts.data, (cart) => {
                            var _a;
                            return openBlock(), createBlock("div", {
                              key: cart.id,
                              class: ["flex flex-row justify-between items-center mb-4", cart.quantity > cart.product.quantity ? "bg-red-200" : ""]
                            }, [
                              createVNode("div", {
                                ...
                                createVNode("span", { class: "ml-1 font-semibold text-sm" }, [
                                  createTextVNode(toDisplayString(unref(truncateString)(cart.product.name)) + " ", 1),
                                  createVNode("br"),
...
const Pos = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-34188d5d"]]);
export {
  Pos as default
};
