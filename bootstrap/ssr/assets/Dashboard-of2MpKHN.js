...
import { _ as _sfc_main$5 } from "./AuthenticatedLayout-BSPNyRzk.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-wrap" }, _attrs))}><div class="w-full px-4 lg:w-6/12 xl:w-3/12">`);
      ...
      _push(`</div><div class="w-full px-4 lg:w-6/12 xl:w-3/12">`);
      _push(ssrRenderComponent(CardStats, {
        statSubtitle: "PROFIT",
      ...
      _push(ssrRenderComponent(CardStats, {
        statSubtitle: "LOSS",
        statTitle: __props.total_loss.selected,
        statArrow: __props.total_loss.stateArray,
        statPercent: __props.total_loss.percentage_change,
        statPercentColor: __props.total_loss.stateArray === "up" ? "text-emerald-500" : "text-red-500",
        statDescripiron: "Since last month",
          ...
          if (_push2) {
            ...
            return [
              createVNode(_sfc_main$1, {
                ...
                total_loss: __props.total_loss,
                total_expense: __props.total_expense
              }, null, 8, ["total_orders", "total_profit", "total_loss", "total_expense"])
            ];
          }
        }),
